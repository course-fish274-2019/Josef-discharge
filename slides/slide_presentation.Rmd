...
* Creates mostly natural flow regime downstrea of dams
* Allows for evaluation of effects of prcipitation and resulting discharge on steelhead migration timing
...
knitr::kable(discharge_and_smolt[1:5,1:6])
```

## Late Spring Discharge vs Smolt Outmigration cont.

* Joined tables of late spring discharge and yearly smolt migratio
