...
Every numbered column represents that month of the year. For example, column 1 holds all the monthly average discharge values for the month of January across all provided years.
